...
CVariousColorsCubeMesh::CVariousColorsCubeMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList
	*pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	SetAABB(XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(1.0f, 1.0f, 1.0f));
...
COneColorsCubeMesh::COneColorsCubeMesh(ID3D12Device * pd3dDevice, ID3D12GraphicsCommandList * pd3dCommandList,
...
COneColorsCubeMesh::~COneColorsCubeMesh()
{
}
